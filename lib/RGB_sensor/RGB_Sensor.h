...
* File:: RGB_Sensor.h
*
* Description:: Defines the interface for the RGB sensor. Along 
*   with necessary macros and registers for 
*   controlling the TCS34725 RGB sensor.
* 
*
**************************************************************/
#pragma once
 ...
 * 
 */
#define RGB_LED_GPIO               15    //physical 10
#define RGB_SDA_GPIO                2     //physical 5
#define RGB_SCL_GPIO                3     //physical 3
